...
const DEFAULT_CONTROLS = [ 'top', 'center', 'bottom', 'space-evenly', 'space-around', 'space-between' ]
const DEFAULT_CONTROL = 'top'
const SPACE_CONTROLS = [ 'space-evenly', 'space-around', 'space-between' ]

export function BlockAlignmentVerticalToolbar( { isCollapsed, value, onChange, controls = DEFAULT_CONTROLS, spaceControlsEnabled = false } ) {
