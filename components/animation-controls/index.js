 ...
 */
import { animationList, delayList, durationList, repeatList } from './definitions'
...
class AnimationControls extends Component {
  ...
  componentDidMount() {
    ...
    if ( className ) {
      ...
      this.setState({
        animation: animationClass ? animationClass.replace( 'animate__', '' ) : 'none',
        delay: delayClass ? delayClass.replace( 'animate__delay-', '' ) : 'default',
        duration: durationClass ? durationClass.replace( 'animate__', '' ) : 'default',
  ...
  updateAnimation( value ) {
    ...
    if ( 'none' !== value ) {
      if ( className ) {
        ...
        const isAnimated = classes.find( currentValue => 'animate__animated' === currentValue )
        ...
        if ( hasAnimationClass ) {
          classes = classes.join( ' ' ).replace( `animate__${ this.state.animation }`, `animate__${ value }` )
        } else {
  ...
  updateDelay( value ) {
    ...
    if ( 'default' !== value ) {
      if ( className ) {
        ...
        if ( hasDelayClass ) {
          classes = classes.join( ' ' ).replace( `animate__delay-${ this.state.delay }`, `animate__delay-${ value }` )
        } else {
  ...
  updateDuration( value ) {
    ...
    if ( 'default' !== value ) {
      if ( className ) {
        ...
        if ( hasDurationClass ) {
          classes = classes.join( ' ' ).replace( `animate__${ this.state.duration }`, `animate__${ value }` )
        } else {
          classes.push( `animate__${ value }` )
          classes = classes.join( ' ' )
        }
  ...
  updateRepeat( value ) {
    ...
    if ( 'default' !== value ) {
      if ( className ) {
        ...
        if ( hasRepeatClass ) {
          classes = classes.join( ' ' ).replace( `animate__${ this.state.repeat }`, `animate__${ value }` )
        } else {
          classes.push( `animate__${ value }` )
          classes = classes.join( ' ' )
        }
